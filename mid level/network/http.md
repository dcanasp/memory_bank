Non secure protocol of data transmition on the web, it follows a client-server model, it runs on the aplication layer of the [[OSI]], it uses by default the port 80 
